...
@section('page.content')
    <form class="row mx-0" action="{{route('admin.category.create')}}" method="POST">
        @csrf
            ...
            <div class="form-group col-12 mb-0">
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" name="isVisible" id="isVisible" checked> La catégorie est visible
                    </label>
                </div>
            </div>
        </div>
