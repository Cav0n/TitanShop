<form action="{{ route('admin.users.administrator.store') }}" method="POST">
    @csrf
    <div class="form-group">
        <label for="firstname">Prénom</label>
        <input type="text" class="form-control" name="firstname" id="firstname" aria-describedby="helpFirstname" value="{{ old('firstname') }}">
        <small id="helpFirstname" class="form-text text-muted">Le prénom de l'administrateur</small>
    </div>

    <div class="form-group">
        <label for="lastname">Nom de famille</label>
        <input type="text" class="form-control" name="lastname" id="lastname" aria-describedby="helpLastname" value="{{ old('lastname') }}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="pseudo" id="pseudo" aria-describedby="helpPseudo" value="{{ old('pseudo') }}">
    ...
    <div class="form-group mb-3">
        <div class="form-check form-check-inline">
            <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name="isActivated" id="isActivated" value="isActivated" @if(old('isActivated')) checked=checked @endif>
