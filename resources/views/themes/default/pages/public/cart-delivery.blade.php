...
@section('page.content')
    ...
    <div class="row">
        <div class="col-12 col-lg-8 d-flex flex-column">
            <form id="delivery-form" class="col-12 col-lg-8 mb-3 mb-lg-0" action="">
                <div class="bg-light p-3 shadow-sm row">
